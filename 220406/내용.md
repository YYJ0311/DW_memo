...
public class Cafe {
	...
	public String memberGrade(String grade) {
		Cafe c = new Cafe();
		System.out.println("임시");
		if(c.getCount(count)<10) {
			System.out.println("등급없음");
			this.memberGrade = "등급없음";
		}
		if(c.getCount(this.count) >= 10 && c.getCount(this.count) <20) {
			this.memberGrade = "Bronze";
		}
		if(c.getCount(count) >= 20 && c.getCount(count) <30) {
			this.memberGrade = "Silver";
		}
		if(c.getCount(count) >= 30) {
			this.memberGrade = "Gold";
		}
		return this.memberGrade;
	}
//	public void membership(int count, String grade) {
//		
//	}
}
...
public class Member {
	public static void main(String[] args) {
		...
		System.out.println("등급 "+c.memberGrade);
	}
}
